...
my $bamFile = "/n/scratch2/kt184/data/RNA/HG00096.1.M_111124_6.bam";
my $refGenome = "/n/scratch2/kt184/data/genome/KT_package/hg19_kt/hg19.fa";
my $chrom = "chr1";
my $outputJobScriptPrefix = "/home/kt184/scratch/results/testMultiCore/generateScripts/analysisRuntime/RNA/sampleRNA1";
...
my $outputPrefix = $outputDirectory . "runRNA1" . ".cores" . $core . ".binSize" . $bin;
