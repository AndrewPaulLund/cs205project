...
<!-- Table of contents generated generated by http://tableofcontent.eu -->
    - [Harvard University - CS205 Computing Foundations for Computational Science - Spring 2018 - Final Project](#harvard-university-cs205-computing-foundations-for-computational-science-spring-2018-final-project)
- [Genomic Sequencing Analysis Parallelization](#genomic-sequencing-analysis-parallelization)
    - [Introduction](#introduction)
    - [Need for parallelization in computational analysis of genomic data](#need-for-parallelization-in-computational-analysis-of-genomic-data)
    - [Need for "efficient" parallelization](#need-for-efficient-parallelization)
    - [Model and Data](#model-and-data)
      - [SNP Analysis Model:](#snp-analysis-model)
      - [This Project's Genome Data:](#this-projects-genome-data)
      - [Data Heterogeneity](#data-heterogeneity)
    - [Infrastructure](#infrastructure)
    - [Installing, Running, & Profiling SAMtools](#installing-running-profiling-samtools)
      - [Installing the SAMtools analysis suite](#installing-the-samtools-analysis-suite)
      - [SAMtools & BCFtools Dataflow](#samtools-bcftools-dataflow)
      - [Running SAMtools on a sample alignment file](#running-samtools-on-a-sample-alignment-file)
- [navigate to the local SAMtools installation](#navigate-to-the-local-samtools-installation)
      - [Profiling BCFtools](#profiling-bcftools)
      - [Relative Timing of SAMtools & bcftools](#relative-timing-of-samtools-bcftools)
- [!/bin/bash](#binbash)
- [SBATCH -p mpi #partition](#sbatch-p-mpi-partition)
- [SBATCH -t 0-24:01 #time days-hr:min](#sbatch-t-0-2401-time-days-hrmin)
- [SBATCH -n 3 #number of tasks](#sbatch-n-3-number-of-tasks)
- [SBATCH --mem=8G #memory per job (all cores), GB](#sbatch-mem8g-memory-per-job-all-cores-gb)
- [SBATCH -o %j.out #out file](#sbatch-o-jout-out-file)
- [SBATCH -e %j.err #error file](#sbatch-e-jerr-error-file)
    - [Results](#results)
    - [Challenges & Advanced Features](#challenges-advanced-features)
      - [Challenge: Profiling](#challenge-profiling)
