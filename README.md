...
- [Installing, Running, & Profiling SAMtools](#installing-running-profiling-samtools)
  ...
  - [Profiling SAMtools](#profiling-samtools)
  - [Profiling BCFtools](#profiling-bcftools)
  - [Relative Timing of SAMtools & bcftools](#relative-timing-of-samtools-bcftools)
- [Description of speedup solutions and comparison with existing work](#description-of-speedup-solutions-and-comparison-with-existing-work)
  - [Literature](#literature)
  - [Our speedup strategy](#our-speedup-strategy)
- [Speedup Techniques](#speedup-techniques)
  - [1. Binning](#1-binning)
  - [2. MPI](#2-mpi)
...
#### 2. MPI
We used MPI to extend the number of cores that we could utlize for
...
#### 3. Load Balancing
Given the heterogeneity of the data as described above,
...
#### 4. OpenMP
Based on the profiling outlined above, we focused our OpenMP
